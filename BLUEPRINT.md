...
- **v1.0.2 ✓** Published quiet-discovery release: Seyir'in bekleme açıklaması ve Divan
  ...
  repo/modüler çekirdek sınırını korumaktır. PR #80
  `f227e2d30ab1a6f010a3d5acf18740f6eab09e70` commit'inde birleşti. Değişmez
  tag/GitHub Release, yedi varlık, checksum, SBOM, attestations, Pages, Wiki ve
  main workflow kanıtı `.divan/evidence/teftis-20260731-v102-release.md`
  kaydında mühürlendi.
