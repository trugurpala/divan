...
from . import engine, project_state, receipts
...
def _rules(locale: str) -> str:
    if locale == "tr":
        body = (
            ...
            "Bu proje gözetimli Divan Proje Sözleşmesini kullanır.\n\n"
        ...
        body = (
            "# Divan Project Rules\n\n"
            "This project uses the supervised Divan Project Contract.\n\n"
