...
class KnowledgeStore:
    ...
    def _connect(self) -> Iterator[sqlite3.Connection]:
        # sqlite3.Connection.__exit__ only ends the transaction, it never closes
        # the handle. Windows keeps the database file locked until it is closed,
        # so leaving it to the garbage collector breaks any caller that removes
