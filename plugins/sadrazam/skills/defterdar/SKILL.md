...
kur (aşağıda) — sormadan.

## Kurulum (ilk ferman / "defter kur")

1. Yukarıdaki iskeleti şablonlardan oluştur (dolu, yer tutucusuz).
2. Git yoksa `git init`; ilk commit: "defter kuruldu".
3. AGENTS.md'ye projenin GERÇEK build/test komutlarını yaz (uydurma; yoksa sor).
4. Para-dokunan projeyse (ödeme, borsa, bakiye): risk-register.md zorunlu,
...
| İcra | progress.md güncelle + anlamlı checkpoint'te `git commit` |
