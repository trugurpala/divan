...
- [ ] Şemayı doğrulayan stdlib-only Python komutu
- [ ] Mevcut `scripts/validate.py` içine salt-okunur registry kontrolü
- [ ] Registry değişiklikleri için fixture testleri
