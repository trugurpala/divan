...
Do not merge while this gate is open.
...
- real `pnpm-lock.yaml` generated by pnpm and committed
- real `Cargo.lock` generated by Cargo and committed for the Desktop application
- CI, acceptance and release lanes use frozen/locked dependency resolution
- no hand-written or synthetic lockfile
- dependency lock drift fails CI
