...
> **Güncel kaynak:** v0.18.1 · **Son yayımlanan:** v0.18.0 · `main` ürün kaynağı · Wiki bu repodaki
...
v0.18.0, v0.17.1'in vibe coder ilerleme sözleşmesini korur ve aynı dokuz
modüllü çekirdeğin `council` modülü içinde Nizâm-ı Sefer planlama zekâsını
yayımlar; ikinci ürün, repo veya üçüncü taraf runtime oluşturmaz.
