...
| **Releases** | `main` sonrası Pages ve Wiki v0.18.5 olunca CHANGELOG'dan otomatik tag/not üretir | Güncel tag'i Releases sayfasından doğrula; üretimde etikete sabitle |
| **Issues + etiketler** | Tekrar üretilebilir hata, kaynak/skill önerisi ve doğrulanmış temiz-proje kanıtı | İhtiyacına uygun formu [SUPPORT.md](../SUPPORT.md) üzerinden aç; boş issue kapalıdır |
