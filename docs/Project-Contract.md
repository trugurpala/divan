# Divan Project Contract

[Türkçe](Project-OS.tr.md)

Divan Project Contract is the supervised, portable contract installed into a target
...
| `divan.py project update --project ...` | Target repository | Migrate and refresh owned project-contract surfaces |
...
See [Divan Engine](Divan-Engine.md) for routing, governance, and pack selection, and
