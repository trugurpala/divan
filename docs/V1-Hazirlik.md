...
| Doğrulanmış temiz-proje kullanımı | 🟡 Hazır; canlı kanıt bekliyor | `.github/ISSUE_TEMPLATE/kabul-kaniti.yml`<br>`plugins/sadrazam/divan_runtime/adoption_common.py`<br>`plugins/sadrazam/divan_runtime/adoption_legacy.py`<br>`plugins/sadrazam/divan_runtime/adoption_schema2.py`<br>`plugins/sadrazam/divan_runtime/adoption_runner.py`<br>`plugins/sadrazam/divan_runtime/adoption.py`<br>`plugins/sadrazam/divan_runtime/adoption_proof_common.py`<br>`plugins/sadrazam/divan_runtime/adoption_proof_execution.py`<br>`plugins/sadrazam/divan_runtime/adoption_proof.py`<br>`tests/test_adoption_v2.py`<br>`tests/test_adoption_proof.py` |
