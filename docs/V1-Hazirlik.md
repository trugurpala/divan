...
| Claude Code ve Codex native Linux/macOS/Windows temiz-host yaşam döngüsü | ✅ Geçti | `.github/workflows/uyumluluk.yml`<br>`scripts/kur-hostlar.py`<br>`tests/test_host_install.py`<br>[https://github.com/trugurpala/divan/actions/runs/29700468615](https://github.com/trugurpala/divan/actions/runs/29700468615) |
